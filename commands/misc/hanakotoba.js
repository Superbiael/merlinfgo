module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        switch (random) {
            ...
            case 3: message.channel.send ("Let's talk about flowers. The language of flowers is \"revenge\" \"misanthropic,\" and \"pessimistic.\" Oh, I wonder who left me these Aconite flowers? Your journey of revenge has nothing to do with me.")
