module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        switch (random) {
            ...
            case 6: message.channel.send ("Let's talk about flowers. The language of the white clover is \"remember me.\" And the language of the four-leaf clover is \"good luck\". While we're at it, why don't you give one to the beautiful knight who is suffering from a low luck?"); break;
