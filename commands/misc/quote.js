module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        switch (random) {
           ...
           case 6: message.channel.send ("Am I good or evil? You are the one who decides that. I am simple - to humans who only go towards the future, I am like an unseen fairy, aren't I?"); break;
