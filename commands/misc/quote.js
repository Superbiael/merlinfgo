module.exports = {
    ...
    aliases: ["q"],
    category: "misc",
    description: "Sends a random quote | alias: q",
    run: async (client, message, args) => {
        ...
        switch (random) {
           ...
           case 19: message.channel.send ("Are you enjoying the casino? Then, that's great! The substance your brain secretes when you gamble is very stimulating. It's vibrant yet simple, much like the feeling of liberation while free falling. Is this what they call a \"thrill\"? \nFor me, it's like alcohol. \nThough it's not gratitude for some future day, I'd like for you to steadily exude it more!"); break;
           case 20: message.channel.send ("I'll bet all my chips on you, I'm counting on you~!"); break;
           case 21: message.channel.send ("A place with no walls, no castles, no countries, the sky of the beginning. The primordial star shining from the earth. Let me show you where the soul resides― The Forever Sealed Utopia, Garden of Avalon!");break;
           case 22: message.channel.send ("What~ I can do anything, you know!"); break;
           case 23: message.channel.send ("I like the world of humans very much, but when it comes to each of them individually, I’m relatively, look, well, yeah!\nVery well, I suddenly feel that some things are better left unsaid!"); break;
           case 24: message.channel.send ("Why I don't use incantations, you ask?\nEven though it's faster to just hit them?"); break;
